...
include('header.php');
   ...
   $msg=$obj->Get_All_Data("select * from message JOIN users on users.uid=message.sender_id where mid=".$_GET['msg_id']."");
		//print_r($msg);														
		$obj->Execute_Query("UPdate message set view=1 where mid=".$_GET['msg_id']."");														
?>
