...
<div class="col-xl-12">
             ...
             <div class="row" id="radio">
               <div class="col-sm-3">
				...
				<div class="col-sm-3">
                       <div class="radio">
							<label>
								<input type="radio" name="allocate_to" id="std" value="student"/><i class="helper"></i>Student
							</label>
						</div>
                 <br/>
               </div>						
		...
		<div class="form-group has-error" id="class_input" style="display:none;">
          ...
          <div class="col-sm-10">
			...
			<option value="no value">Select Class</option>
             <?php
		...
		<div class="col-sm-2"></div>
          <div class="col-sm-10">
		  <br/><br/>
           <input type="hidden" name="add_fee_allocation">
...
jQuery("#form_data").submit(function(e){
		...
		$.ajax({
			...
			if(response ==='Fee Allocated Successfully')
			{
