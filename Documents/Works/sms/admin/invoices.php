...
<div class="col-xl-12">
 ...
 JOIN student on reciept.std_id=student.uid");
 ?>
 <thead>
 <tr><th> S/N</th><th> Title</th><th>Description</th><th>Amount</th><th>Student</th> <th>Pay</th> <th>Edit </th> <th>Delete </th> </tr>
 </thead>
 <tbody>
...
$n=0;
 ...
 <td> 
 <a class=" waves-light btn btn-primary" href="edit_invoice.php?re_id=<?php echo base64_encode($trans[$i]['re_id']); ?>"><i class="fa fa-pencil"></i></a></td>
 
  <td>  

  <a class="waves-light btn btn-danger" onclick="Delete_Record('Invoice Deleted Sucessfully','reciept','re_id','<?php echo $trans[$i]['re_id'] ?>','ring<?php echo $trans[$i]['re_id'] ?>','invoices.php')"><i class="fa fa-trash-o "></i> <img style="display:none" width="30" id="ring<?php echo $trans[$i]['re_id'] ?>" src="../assets/images/ring.gif"/> </a>
