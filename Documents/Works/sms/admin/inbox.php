                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover email-table">
												   ...
												   $msg=$obj->Get_All_Data("select * from message 
																JOIN users on users.uid=message.sender_id where reciever_id=".$_SESSION['uid']." or reciever_id=0");
												   ...
												   ?>
                                                    <tr class="unread">
                                                        ...
                                                        <td><a href="read_mail.php?msg_id=<?php echo $msg[$i]['mid']; ?>" class="email-name"><?php echo $msg[$i]['username']; ?></a></td>
                                                        <td><a href="read_mail.php?msg_id=<?php echo $msg[$i]['mid']; ?>" class="email-name"></a><?php echo $obj->Hide_Some($msg[$i]['content']); ?></td>
