...
<div class="col-xl-12">
        ...
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.fullName.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="fullName" ng-model="form.fullName" class="form-control" required="" placeholder="Full name">
          </div>
        </div>
		<br/> <br/>
        ...
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.email.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="email" name="email" ng-model="form.email" class="form-control ng-dirty ng-valid-required ng-invalid ng-invalid-email" placeholder="Email address" required="">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.password.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="password" name="password" ng-model="form.password" required="" class="form-control ng-dirty ng-invalid ng-invalid-required" placeholder="Password">
          </div>
        </div>
		<br/> <br/>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" date-picker="" id="datemask" name="birthday" ng-model="form.birthday" class="form-control datemask ng-pristine ng-valid">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group">
        ...
        <div class="form-group" ng-class="{'has-error': addAdmin.mobileNo.$invalid}">
          ...
          <div class="col-sm-10">
          <input type="text" name="mobileNo" class="form-control ng-pristine ng-valid" ng-model="form.phoneNo" placeholder="Phone No">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="parentProfession" class="form-control ng-pristine ng-valid" ng-model="form.parentProfession" placeholder="Profession">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group">
		...
		<div class="col-sm-2"></div>
          <div class="col-sm-10">
           <input type="hidden" name="add_parent">
