...
<div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-header-text">Add Expenses</h5>
                           <div class="f-right">
		...
		<br/> <br/>
		 ...
		 <div class="form-group has-error" ng-class="{'has-error': addAdmin.fullName.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="amount" ng-model="form.fullName" class="form-control" required="" placeholder="Amount">
          </div>
        </div>
		<br/> <br/>
		 <div class="form-group has-error" ng-class="{'has-error': addAdmin.fullName.$invalid}">
		...
		<br/> <br/>
		 <div class="form-group has-error" ng-class="{'has-error': addAdmin.fullName.$invalid}">
          ...
          <div class="col-sm-10">
            <textarea name="note" ng-model="form.fullName" class="form-control" required=""></textarea>
          </div>
        </div>
		<br/> <br/>
		...
		<div class="col-sm-2"></div>
          <div class="col-sm-10">
           <input type="hidden" name="add_expenses">
...
<script type="text/javascript">
						...
						jQuery("#form_data").submit(function(e){
								...
								$.ajax({
									...
									if(response ==='Expense Created Successfully')
									{
