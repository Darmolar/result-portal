...
<div class="col-xl-12">
 ...
 <?php
 $trans=$obj->Get_All_Data("select * from examslist where examslist.school_id=".$_SESSION['school_id']."");
 ?>
 <thead>
...
?>
 <div class="dropdown-primary dropdown">
        ...
        <a class="dropdown-item waves-light" href="edit_exam.php?exam=<?php echo base64_encode($trans[$i]['id']) ?>">Edit</a>
       ...
       <a class="waves-light btn btn-primary md-trigger"  href="#"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Upload" data-modal="modal-9"><i class="fa fa-calculator "></i>Grade
        ...
        <a class="dropdown-item waves-light waves-effect" href="#"onclick="Delete_Record('Exam Deleted Sucessfully','examslist','id','<?php echo $trans[$i]['id'] ?>','ring<?php echo $trans[$i]['id'] ?>','exam_list.php')">
		Delete<img style="display:none" width="30" id="ring<?php echo $trans[$i]['id'] ?>" src="../assets/images/ring.gif"/></a>
        </div>
        </div>
