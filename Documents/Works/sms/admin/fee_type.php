...
<div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-header-text">Add Fee Type</h5>
                           <div class="f-right">
        ...
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.fullName.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="title" ng-model="form.fullName" class="form-control" required="" placeholder="Title">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.username.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="description" ng-model="form.username" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Description">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.email.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="number" name="amount" ng-model="form.email" class="form-control ng-dirty ng-valid-required ng-invalid ng-invalid-email" placeholder="Amount" required="">
          </div>
		  <br/><br/>
        </div>
		...
		<div class="col-sm-2"></div>
          <div class="col-sm-10">
           <input type="hidden" name="add_fee_type">
...
<script type="text/javascript">
						...
						jQuery("#form_data").submit(function(e){
								...
								$.ajax({
									...
									if(response ==='Fee Types Created Successfully')
									{
