...
<div class="col-xl-12">
        ...
        <div class="form-group has-error" ng-class="{'has-error': addDorm.subjectTitle.$invalid}">
          ...
          <div class="col-sm-12">
		   <div class="md-input-wrapper">
            <input type="text" name="subjectTitle" ng-model="form.subjectTitle" class="form-control ng-pristine ng-invalid ng-invalid-required md-form-control md-static" required="" placeholder="Subject name" required> </div>
          </div>
        </div>
        <div class="form-group has-error" ng-class="{'has-error': addDorm.teacherId.$invalid}">
          <label for="inputPassword3">Teacher *</label>
          <div class="col-sm-12">
            <select class="form-control ng-pristine ng-invalid ng-invalid-required md-form-control md-static" name="teacherId[]" required>
        ...
        <div class="form-group has-error" ng-class="{'has-error': addDorm.passGrade.$invalid}">
          ...
          <div class="col-sm-12">
		   <div class="md-input-wrapper">
            <input type="text" name="passGrade" ng-model="form.passGrade" class="form-control ng-pristine ng-invalid ng-invalid-required md-form-control md-static" required placeholder="Pass grade" ></div>
          </div>
        </div>
        <div class="form-group has-error" ng-class="{'has-error': addDorm.finalGrade.$invalid}">
          ...
          <div class="col-sm-12">
            <input type="text" name="finalGrade" ng-model="form.finalGrade" class="form-control ng-pristine ng-invalid ng-invalid-required md-form-control md-static" required placeholder="Final grade">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class=" col-sm-12">
		  <br/>
		  <input type="hidden" name="create_subject">
...
<script type="text/javascript">
						...
						jQuery("#form_data").submit(function(e){
								...
								$.ajax({
									...
									if(response ==='Subject Created Successfully')
									{
