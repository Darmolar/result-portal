...
<div class="col-xl-12">
        ...
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.username.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="username" ng-model="form.username" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Username" value="<?php if(isset($data['username'])) { echo $data['username']; }  ?>" />
          </div>
        </div>
		<br/> <br/>
        ...
        <div class="form-group" ng-class="{'has-error': addAdmin.mobileNo.$invalid}">
          ...
          <div class="col-sm-10">
          <input type="text" name="mobileNo" class="form-control ng-pristine ng-valid" ng-model="form.phoneNo" placeholder="Mobile No" value="<?php if(isset($data['mobileNo'])) { echo $data['mobileNo']; }  ?>">
          </div>
        </div>
		<br/> <br/>
        <div class="form-group">
