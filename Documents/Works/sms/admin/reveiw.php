...
//print_r($trans);
 ?>
 <thead>
 <tr><th> S/N</th><th>Student</th><th>Score</th><th>Date</th><th> View  </th>  <th>Edit </th> <th>Delete </th> </tr>
 </thead>
 <tbody>
...
$n=0;
 ...
 <a class=" waves-light btn btn-primary" href="questions.php?oexam_id=<?php echo base64_encode($trans[$i]['ID']); ?>"><i class="fa fa-eye"></i></a>
