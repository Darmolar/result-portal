...
<div class="col-xl-12">
 ...
 JOIN section on section.sec_id=study_material.section where study_material.school_id=".$_SESSION['school_id']."");
 //print_r($trans);
 ?>
 <thead>
 <tr><th> S/N</th><th> Title</th><th> Description</th><th>Class</th> <th>Section </th><th>File</th><th>Date </th></tr>
 </thead>
 <tbody>
