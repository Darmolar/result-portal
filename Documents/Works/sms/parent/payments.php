...
<div class="col-xl-12">
 ...
 JOIN student on reciept.std_id=student.uid where reciept.status=1 and student.uid=".$_SESSION['std_id']." ");
 ?>
 <thead>
 <tr><th> S/N</th><th> Title</th><th>Description</th><th>Amount</th><th>Student</th> <th>Transaction Ref</th> </tr>
 </thead>
 <tbody>
