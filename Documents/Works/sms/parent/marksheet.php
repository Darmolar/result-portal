...
//$grade=$obj->Get_All_Data("select * from grade JOIN student on student.class=grade.class_id where grade.uid=".$_SESSION['uid']."");
$grade=$obj->Get_All_Data("select * from grade where grade.uid=".$_SESSION['std_id']."");
//print_r($grade);
?>
