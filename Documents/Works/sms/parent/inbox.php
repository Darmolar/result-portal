                                                ...
                                                <table class="table table-hover email-table">
												   ...
												   ?>
                                                    <tr class="unread">
                                                        ...
                                                        <td><a href="read_mail.php?msg_id=<?php echo base64_encode($msg[$i]['mid']); ?>" class="email-name"><?php echo $msg[$i]['username']; ?></a></td>
                                                        <td><a href="read_mail.php?msg_id=<?php echo base64_encode($msg[$i]['mid']); ?>" class="email-name"></a><?php echo $obj->Hide_Some($msg[$i]['content']); ?></td>
