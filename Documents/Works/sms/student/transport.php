...
<div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                              <form class="form-horizontal" name="addDorm" method="POST" id="form_data">
        <div class="form-group has-error" ng-class="{'has-error': addDorm.transportTitle.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="title" ng-model="form.transportTitle" class="form-control" required="" placeholder="Transport title">
          </div>
        </div>
		<br>
		<br>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea name="desc" class="form-control ng-pristine ng-valid" ng-model="form.transportDescription" placeholder="Transport Description"></textarea>
          </div>
        </div>
		<br>
		<br>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea name="contact" class="form-control ng-pristine ng-valid" ng-model="form.transportDriverContact" placeholder="Driver Contact"></textarea>
          </div>
        </div>
		<br>
		<br>
        <div class="form-group has-error" ng-class="{'has-error': addDorm.transportFare.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="fare" ng-model="form.transportFare" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Fare">
          </div>
        </div>
		<br>
		<br>
        <div class="form-group">
          <div class="col-sm-12">
            	<input type="hidden" name="create_transport">
...
<script type="text/javascript">
						...
						jQuery("#form_data").submit(function(e){
								...
								$.ajax({
									...
									if(response ==='Transportation Created Successfully')
									{
