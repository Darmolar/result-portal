...
$data=$obj->Get_All_Data("select * from event where eid=$eid");
//print_r($data);
?>
                            ...
                            <div class="main-header" style="margin-top: 0px;">
                                ...
                                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                   ...
                                   <li class="breadcrumb-item"><a href="event.php">Event</a></li>
                                    ...
                                    <li class="breadcrumb-item"><a href="edit_event.php">Edit Event</a></li>
...
<div class="col-xl-12">
        ...
        <div class="form-group has-error" ng-class="{'has-error': addEvent.eventTitle.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="hidden" name="eid" ng-model="form.eventTitle" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Event Title" value="<?php echo $data[0]['eid'];  ?>"/>
			
			
            <input type="text" name="title" ng-model="form.eventTitle" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Event Title" value="<?php echo $data[0]['title'];  ?>"/>
          </div>
        </div>
		<br>
		<br>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea ck-editor="" name="eventdesc" class="form-control" placeholder="Event Description" ><?php echo $data[0]['desc'];  ?></textarea>
          </div>
        </div>
		<br>
		<br>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="eventplace" ng-model="form.enentPlace" class="form-control ng-pristine ng-valid" placeholder="Event Place" value="<?php echo $data[0]['place'];  ?>">
          </div>
        </div>
		<br>
		<br>
 ...
 <select name="eventfor" class=" form-control" tabindex="-1" aria-hidden="true">
									<option value="<?php echo $data[0]['for'];  ?>"><?php echo $data[0]['for'];  ?></option>
        ...
        <div class="form-group has-error" ng-class="{'has-error': addEvent.eventDate.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="date" id="datemask" name="eventdate" class="form-control" value="<?php echo $data[0]['date'];  ?>">
          </div>
        </div>
		<br>
		<br>
