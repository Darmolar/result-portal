...
<div class="col-xl-12">
 ...
 ?>
 <thead>
 <tr><th> S/N</th><th>Class Name</th><th>Class Teacher</th><th>Date </th> <th>View </th></tr>
 </thead>
 <tbody>
...
$n=0;
 ...
 <td><?php echo $trans[$i]['date']; ?></td>
  ...
  <td>   
<a class="waves-light btn btn-primary" target="blank" href="classes_schedule.php?cl_id=<?php echo base64_encode($trans[$i]['cl_id']); ?>"  data-toggle="tooltip" data-placement="top" title="" data-original-title="View Schedule" ><i class="fa fa-eye "></i>
