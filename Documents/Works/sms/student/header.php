...
$photo_data=$obj->Get_All_Data("SELECT * FROM `student` join users on users.uid=student.uid");
//print_r($photo);
            ...
            <ul class="sidebar-menu">
               ...
               <!-- <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i>
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span>Attendance</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="attendance_stats.php"><i class="icon-arrow-right"></i> Attendance</a></li>
               ...
               <!-- <li><a href="#"><i class="icofont icofont-multimedia"></i><span> Media Center</span></a> </li>-->
                ...
                <li><a href="online_exam_list.php"><i class="icofont icofont-law-book"></i><span> Online Exam</span></a> </li>
                ...
                <li><a href="marksheet.php"><i class="icofont icofont-book-alt"></i><span> Marksheet</span></a> </li>
				 ...
				 <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Accounting </span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        ...
                        <li><a class="waves-effect waves-dark" href="invoices.php"><i class="icon-arrow-right"></i> Payment</a></li>
                        <li><a class="waves-effect waves-dark" href="payments.php"><i class="icon-arrow-right"></i> Paid</a></li>
                    </ul>
                </li>
