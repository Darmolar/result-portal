...
<div class="col-xl-12">
 ...
 JOIN student on reciept.std_id=student.uid where reciept.status=1 and student.uid=".$_SESSION['uid']." ");
 ?>
 <thead>
 <tr><th> S/N</th><th> Title</th><th>Description</th><th>Amount</th><th>Student</th> <th>Transaction Ref</th>  <th>Delete </th> </tr>
 </thead>
 <tbody>
...
$n=0;
 ...
 <td><?php echo $trans[$i]['ref'] ?></td>
<td>
  <a class="waves-light btn btn-danger" onclick="Delete_Record('Invoice Deleted Sucessfully','reciept','re_id','<?php echo $trans[$i]['re_id'] ?>','ring<?php echo $trans[$i]['re_id'] ?>','invoices.php')" href=""><i class="fa fa-trash-o "></i> <img style="display:none" width="30" id="ring<?php echo $trans[$i]['re_id'] ?>" src="../assets/images/ring.gif"/> </a>
