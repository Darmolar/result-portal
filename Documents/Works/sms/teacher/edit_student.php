...
if(isset($_GET['uid'])){
	...
	$data=$obj->Get_All_Data("select * from student 
	Join class on class.cl_id=student.class 
	Join section on section.sec_id=student.section 
	Join transportation on transportation.t_id=student.transport where uid='$uid'");
}
//print_r($data);
?>
                        ...
                        <div class="col-sm-12 p-0">
                            <div class="main-header" style="margin-top: 0px;">
                                ...
                                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                    ...
                                    <li class="breadcrumb-item"><a href="students_list.php">Student List</a></li>
                                    <li class="breadcrumb-item"><a href="edit_student.php">Edit Student</a></li>
...
<div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-header-text">Edit Student</h5>
                           <div class="f-right">
        ...
        <div class="form-group has-error">
          ...
          <div class="col-sm-10">
            <input type="hidden" name="uid" class="form-control" required placeholder="Full name" value="<?php echo $data[0]['uid']  ?>">
			
            <input type="text" name="fname" class="form-control" required placeholder="Full name" value="<?php echo $data[0]['fname']  ?>">
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="rollid" class="form-control" placeholder="Roll id" value="<?php echo $data[0]['rollid']  ?>">
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.username.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="username" ng-model="form.username" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Username" value="<?php echo $data[0]['username']  ?>" readonly />
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.email.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="email" name="email" ng-model="form.email" class="form-control ng-dirty ng-valid-required ng-invalid ng-invalid-email" placeholder="Email address" ng-required="$root.dashboardData.emailIsMandatory == '1'" required="required" value="<?php echo $data[0]['email']  ?>" readonly />
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group has-error" ng-class="{'has-error': addAdmin.password.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="password" name="password" ng-model="form.password" class="form-control ng-dirty ng-invalid ng-invalid-required" required="" placeholder="Password" value="<?php echo $data[0]['password']  ?>">
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group">
		<br/>
         ...
         <div class="row">
                                ...
                                <div class="col-sm-1">
                                           <div class="radio">
												<label>
													<input type="radio" name="gender" value="male" <?php if ($data[0]['gender']=="male") echo  'checked'; ?>><i class="helper"></i>Male
												</label>
											</div>
                                </div>
                                <div class="col-sm-1">
                                           <div class="radio">
												<label>
													<input type="radio" name="gender" value="female" <?php if ($data[0]['gender']=="female") echo  'checked'; ?>><i class="helper"></i>Female
												</label>
											</div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="date" id="datemask" name="birthday" ng-model="form.birthday" class="form-control datemask ng-pristine ng-valid" value="<?php echo $data[0]['bday']  ?>">
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="address" class="form-control ng-pristine ng-valid" ng-model="form.address" placeholder="Address" value="<?php echo $data[0]['add']  ?>">
          </div>
        </div>
		<br/><br/><br/>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="phone" class="form-control ng-pristine ng-valid" ng-model="form.phoneNo" placeholder="Phone No" international-phone-number="" value="<?php echo $data[0]['phone']  ?>">
          </div>
        </div>
       <br/><br/><br/>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select class="form-control ng-pristine ng-valid" name="transport" ng-model="form.transport">
			
			<option value="<?php echo $data[0]['t_id'] ?>"><?php echo $data[0]['title'] ?></option>
        ...
        <div class="form-group">
           <div class="col-sm-12">
           <input type="hidden" name="edit_student"/>
