...
//$_SESSION['uid']=$obj->Get_All_Data("select * from teacher where username='".$_SESSION['username']."'")[0]['uid'];
                ...
                <ul class="top-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu settings-menu">
                            ...
                            <li><a href="../logout.php"><i class="icon-lock"></i> Lock Screen</a></li>
        ...
        <section class="sidebar" id="sidebar-scroll">
            <div class="user-panel">
                ...
                <div class="f-left info">
                    ...
                    <p class="designation">Teacher <i class="icofont icofont-caret-down m-l-5"></i></p>
                </div>
            </div>
            ...
            <ul class="sidebar-menu">
               ...
               <!--  <li><a href="inbox.php"><i class="icofont icofont-ui-message"></i><span> Messages</span></a> </li> -->
                ...
                <li><a href="students_list.php"><i class="icofont icofont-funky-man"></i><span> Student</span></a> </li>
              <!--  <li><a href="#"><i class="icofont icofont-chart-bar-graph"></i><span> Report</span></a> </li>-->
                <li><a href="inbox.php"><i class="icofont icofont-envelope-open"></i><span> Mail/SMS</span></a> </li>
				  ...
				  <!--<li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Classes </span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        ...
                        <li><a class="waves-effect waves-dark" href="add_section.php"><i class="icon-arrow-right"></i> Session</a></li>
                    </ul>
                </li>
				...
				<li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Accounting </span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="chartjs.html"><i class="icon-arrow-right"></i> Payment</a></li>
                    </ul>
                </li>-->
