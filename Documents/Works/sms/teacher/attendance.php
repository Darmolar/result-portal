...
<div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form class="form-horizontal ng-dirty ng-valid ng-valid-required" name="attendance" method="POST" action="mark_attendance.php">
          ...
          <div class="col-sm-10">
           <select class="form-control ng-pristine ng-invalid ng-invalid-required" name="class"  onchange="Get_Section(this.value); Get_Subject(this.value)" required>
			<option value="">Select Class</option>
             <?php
									 $teacher=$obj->Get_All_Data("select * from class where clteacher=".$_SESSION['uid']."");
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select class="form-control ng-dirty ng-valid ng-valid-required" id="section" name="sectionId" required="required">
