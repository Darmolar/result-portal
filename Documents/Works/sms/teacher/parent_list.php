...
$n=0;
 ...
 <td>   
<a class="waves-light btn btn-danger" onclick="Delete_Record('Parent Deleted Sucessfully','parent','uid','<?php echo $trans[$i]['uid'] ?>','ring<?php echo $trans[$i]['uid'] ?>','parent_list.php')"><i class="fa fa-trash-o "></i> <img style="display:none" width="30" id="ring<?php echo $trans[$i]['uid'] ?>" src="../assets/images/ring.gif"/> </a>
</td>
<td> 
