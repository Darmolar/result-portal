...
$lib_id=base64_decode($_GET['lib_id']);

$data=$obj->Get_All_Data("select * from library where lib_id=$lib_id");
//print_r($data);
?>
                        ...
                        <div class="col-sm-12 p-0">
                            <div class="main-header" style="margin-top: 0px;">
                                ...
                                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                    ...
                                    <li class="breadcrumb-item"><a href="library_list.php">List Library</a></li>
                                    <li class="breadcrumb-item"><a href="edit_library.php">Edit Libary</a></li>
...
<div class="col-xl-12">
        ...
        <div class="form-group has-error" ng-class="{'has-error': addDorm.bookName.$invalid}">
          ...
          <div class="col-sm-10">
            <input type="text" name="book_name" ng-model="form.bookName" class="form-control ng-pristine ng-invalid ng-invalid-required" required="" placeholder="Book title" value="<?php echo $data[0]['title']; ?>">
          </div>
        </div>
		<br/><br/>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea name="bookdesc" class="form-control" ng-model="form.bookDescription" placeholder="Book Description"><?php echo $data[0]['desc']; ?></textarea>
          </div>
        </div>
			<br/><br/>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="bookauthor" ng-model="form.bookAuthor" class="form-control ng-pristine ng-valid" placeholder="Book Author" value="<?php echo $data[0]['author']; ?>">
          </div>
        </div>
			<br/><br/>
        ...
        <div class="form-group ng-hide" id="trad">
          ...
          <div class="col-sm-10">
            <input type="text" name="bookprice" ng-model="form.bookPrice" class="form-control ng-pristine ng-valid" placeholder="Book Price" value="<?php echo $data[0]['price']; ?>">
          </div>
        </div>
			<br/><br/>
