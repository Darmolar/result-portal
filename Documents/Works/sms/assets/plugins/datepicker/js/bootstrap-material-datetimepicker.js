   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-now btn btn-primary waves-effect waves-light m-r-5 hidden">' + this.params.nowText + '</button>' +
                         '<button class="dtp-btn-clear btn btn-primary waves-effect waves-light m-r-5 hidden">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel btn btn-primary waves-effect waves-light m-r-5">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok btn btn-primary waves-effect waves-light m-r-5">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
              ...
              createSVGClock: function (isHour)
              {
                 ...
                 if (isHour)
                 {
                    ...
                    var svgHourHand = this.createSVGElement("line", {class: 'hour-hand', x1: 0, y1: 0, x2: 0, y2: hl, stroke: '#2196F3', 'stroke-width': 8});

                    svgGElement.appendChild(svgMinuteHand);
                    svgGElement.appendChild(svgHourHand);
                 } else
                 {
                    var svgMinuteHand = this.createSVGElement("line", {class: 'minute-hand', x1: 0, y1: 0, x2: 0, y2: -150, stroke: '#2196F3', 'stroke-width': 2});
