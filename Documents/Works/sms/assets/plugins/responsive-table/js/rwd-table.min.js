...
!function(a) {
    ...
    var e=function(b,
        ...
        ;
    e.DEFAULTS= {
        pattern: "priority-columns", stickyTableHeader: !0, fixedNavbar: ".navbar-fixed-top", addDisplayAllBtn: !0, addFocusBtn: !0, focusBtnIcon: "glyphicon glyphicon-screenshot"
    }
        ,
        ...
        e.prototype.createButtonToolbar=function() {
            ...
            this.options.addDisplayAllBtn&&(this.$displayAllBtn=a('<button class="btn btn-default">Display all</button>'),
        ...
        ,
        e.prototype.displayAll=function(b,
                                        c) {
        ...
        e.prototype.createStickyTableHeader=function() {
            ...
            b.$tableClone=b.$table.clone(), b.$tableClone.prop("id", this.id+"-clone"), b.$tableClone.find("[id]").each(function() {
                ...
                b.$stickyTableHeader.css("height",
                    b.$thead.height()+2),
                a("html").hasClass("lt-ie10")?b.$tableWrapper.prepend(b.$stickyTableHeader):b.$table.before(b.$stickyTableHeader),
                a(window).bind("scroll resize",
                    function() {
                        a.proxy(b.updateStickyTableHeader(), b)
                    }
                ),
                a(b.$tableScrollWrapper).bind("scroll",
                    function() {
                        a.proxy(b.updateStickyTableHeader(), b)
                    }
                )
        ...
        e.prototype.updateStickyTableHeader=function() {
            var b=this, c=0, d=b.$table.offset().top, e=a(window).scrollTop()-1, f=b.$table.height()-b.$stickyTableHeader.height(), g=e+a(window).height()-a(document).height(), h=!b.iOS, i=0;
            ...
            if(h) {
                if(b.$stickyTableHeader.scrollLeft(b.$tableScrollWrapper.scrollLeft()), b.$stickyTableHeader.addClass("fixed-solution"), c=i-1, e-d>f?(c-=e-d-f, b.$stickyTableHeader.addClass("border-radius-fix")): b.$stickyTableHeader.removeClass("border-radius-fix"), k)return void b.$stickyTableHeader.css( {
                        visibility: "visible", top: c+"px", width: b.$tableScrollWrapper.innerWidth()+"px"
                    }
                );
        ...
        e.prototype.setupHdrCells=function() {
            ...
            b.$hdrCells.each(function(c) {
                    var d=a(this), e=d.prop("id"), f=d.text();
                    if(e||(e=b.idPrefix+c, d.prop("id", e)), ""===f&&(f=d.attr("data-col-name")), d.is("[data-priority]")) {
                        var g=a('<li class="checkbox-row"><input type="checkbox" name="toggle-'+e+'" id="toggle-'+e+'" value="'+e+'" /> <label for="toggle-'+e+'">'+f+"</label></li>"), h=g.find("input");
                        ...
                        a("html").hasClass("lt-ie9")&&h.click(function() {
                            ...
                            g.find("input").click(function(a) {
                                    ...
                                    var c=a(this), d=c.val(), e=b.$tableWrapper.find("#"+d+", #"+d+"-clone, [data-columns~="+d+"]");
        ...
        e.prototype.setupStandardCells=function() {
            ...
            b.$bodyRows.each(function() {
                    ...
                    a(this).find("th, td").each(function() {
                            for(var d=a(this), e="", f=d.prop("colSpan"), g=0, h=c;
                                c+f>h;
                                h++) {
                                e=e+" "+b.idPrefix+h;
                                var i=b.$tableScrollWrapper.find("#"+b.idPrefix+h), j=i.attr("data-priority");
                                j&&d.attr("data-priority", j), "none"===i.css("display")&&g++
                            }
                            f>1&&(d.addClass("spn-cell"),
                                g!==f?d.show():d.hide()),
                                d.prop("colSpan",
                                    Math.max(f-g,
                                        1)),
        ...
        e.prototype.updateSpanningCells=function() {
            ...
            b.$table.find(".spn-cell").each(function() {
                    for(var b=a(this), c=b.attr("data-columns").split(" "), d=c.length, e=0, f=0;
                        d>f;
                        f++)"none"===a("#"+c[f]).css("display")&&e++;
    ...
    a.fn.responsiveTable=function(b) {
        return this.each(function() {
                var c=a(this), d=c.data("responsiveTable"), f=a.extend( {}, e.DEFAULTS, c.data(), "object"==typeof b&&b);
                ""!==f.pattern&&(d||c.data("responsiveTable", d=new e(this, f)), "string"==typeof b&&d[b]())
            }
        )
    }
        ,
        a.fn.responsiveTable.Constructor=e,
        a.fn.responsiveTable.noConflict=function() {
            return a.fn.responsiveTable=f, this
        }
        ,
        a(document).on("ready.responsive-table.data-api",
            function() {
        ...
        a(document).on("click.dropdown.data-api",
