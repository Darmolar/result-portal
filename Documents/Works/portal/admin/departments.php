  			...
  			<div class="container-fluid">
  				<div class="row">
  					<div class="col-md-12 col-12">
  						<h6><a href="./dasboard">Dashboard</a> > <a href="./departments">Departments</a></h6>
  					</div>

  					<div class="col-md-4 p-3 text-center con">
  						<p>Register a new Course</p>
  						<div class="form">
  							<form method="post" id="submitDepartment">
  							  <div class="form-group"> 	
  								<input type="text" name="addDepartment" placeholder="Enter Department" class="form-control">
  							  </div>
  							  <div class="form-group">
                    <input type="hidden" name="addDepartments">
