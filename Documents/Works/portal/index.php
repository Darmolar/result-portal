		  ...
		  <div class="container-fluid">
		  	<div class="form">
		  		<form id="loginForm" class="text-center" method="POST">
					  ...
					  <input type="text" accept="number" class="form-control" id="matricNo" name="matricNo" placeholder="Matric Number" aria-label="Matric Number" aria-describedby="basic-addon1">
					...
					<div class="form-group">
						<input type="hidden" name="loginDetails">
						<button class="btn btn-primary" type="submit">Submit</button>
					</div>
		  		</form>
		  		<div class="container">
		  			<p class="float-right"><a href="./signup">SignUp</a> as Student</p>
